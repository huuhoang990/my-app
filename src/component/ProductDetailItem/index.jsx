...
export default  function ProductDetail(props) {
	...
	arrProduct.forEach(function(element, idx) {
		if (element.product_id == idProduct) {
			productItem = element
			return
		}
	});
          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-8">
              <div class="product-details mb-30 pl-30">
                ...
                <h2 class="pro-details-title mb-15">{productItem.name}</h2>
                <div class="details-price mb-20">
                  <span>{productItem.price}</span>
                  <span class="old-price">{productItem.final_price}</span>
                </div>
